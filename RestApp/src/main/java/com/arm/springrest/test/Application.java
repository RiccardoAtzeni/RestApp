package com.arm.springrest.test;
/*
...
import com.arm.springrest.data.Customer;*/
...
{	
	...
	public void run(String... arg0) throws Exception 
	{
		...
		List<Object[]> splitUpNames = Arrays.asList("John Woo", "Jeff Dean", "Josh Bloch", 
				"Josh Long").stream().map(name -> name.split(" ")).collect(Collectors.toList());
		
		//Print a List of string's arrays
		//splitUpNames.stream().forEach(name -> Arrays.stream(name).forEach(System.out::println));
